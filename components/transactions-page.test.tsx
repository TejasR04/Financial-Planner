...
describe("transaction ledger", () => {
  it("uses totals for all matches and preserves exclusions when assigning a category", async () => {
    ...
    mocks.list.mockResolvedValue({ data: [{ id: "one", account_id: "a", merchant: "Cafe", amount: "-10", posted_at: "2026-09-01", type: "expense", status: "cleared", budget_category_id: null, budget_category_name: null, ignored_from_budget: true }], total: 51, totals: { inflow: "25", outflow: "500", net: "-475" } });
